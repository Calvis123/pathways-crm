  ...
  return (
    <div className="space-y-6">
      <Card className="dark:border-white/10 dark:bg-[#0d1729]">
        ...
        {status ? (
          <p className="mt-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600 dark:border-white/10 dark:bg-white/[0.05] dark:text-slate-300">
            {status}
          </p>
        ) : null}
      </Card>
          ...
          <table className="min-w-full text-left text-sm">
            ...
            <tbody>
              {access.length === 0 ? (
                ...
                access.map((entry) => (
                  <tr key={entry.id} className="border-t border-slate-100 dark:border-white/10">
                    <td className="py-3">
      ...
      <Card className="dark:border-white/10 dark:bg-[#0d1729]">
        ...
        <form className="grid gap-4 md:grid-cols-2" onSubmit={sendMessage}>
          ...
          <label className="text-sm text-slate-600 md:col-span-2 dark:text-slate-300">
            ...
            <textarea
              className="min-h-28 w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 dark:border-white/10 dark:bg-white/[0.06] dark:text-white"
          ...
          <div className="space-y-3">
            {messages.length === 0 ? (
              ...
              messages.map((message) => (
                <div key={message.id} className="rounded-2xl border border-slate-100 bg-slate-50 p-4 dark:border-white/10 dark:bg-white/[0.04]">
        ...
        <Card className="dark:border-white/10 dark:bg-[#0d1729]">
          ...
          <div className="space-y-3">
            {activity.length === 0 ? (
              ...
              activity.map((item) => (
                <div key={item.id} className="rounded-2xl border border-slate-100 bg-slate-50 p-4 dark:border-white/10 dark:bg-white/[0.04]">
                  <div className="flex items-center justify-between gap-3">
