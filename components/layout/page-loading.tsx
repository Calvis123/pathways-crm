export function PageLoading({
  ...
  return (
    <div className="min-h-[70vh]">
      <div className="overflow-hidden rounded-xl border border-[#eadacc]/80 bg-white/90 shadow-[0_24px_60px_rgba(15,23,42,0.08)] backdrop-blur">
        <div className="border-b border-[#eadacc] bg-[radial-gradient(circle_at_top_left,rgba(255,122,89,0.16),transparent_24%),linear-gradient(135deg,rgba(255,255,255,0.96),rgba(247,243,234,0.96))] p-8">
        ...
        <div className="grid gap-5 p-8 lg:grid-cols-[1.45fr_0.9fr]">
          <div className="space-y-5">
            <div className="grid gap-4 md:grid-cols-3">
              {Array.from({ length: 3 }).map((_, index) => (
                <div
                  key={index}
                  className="rounded-2xl border border-[#eadacc] bg-[linear-gradient(180deg,#fffdf8_0%,#fff6eb_100%)] p-5"
                >
            ...
            <div className="rounded-[1.5rem] border border-[#eadacc] bg-white p-6">
              <div className="h-5 w-48 animate-pulse rounded-full bg-slate-200" />
              <div className="mt-6 space-y-4">
                {Array.from({ length: 5 }).map((_, index) => (
                  <div key={index} className="rounded-2xl border border-[#f0dfd0] bg-[#fffaf5] p-4">
          ...
          <div className="space-y-5">
            <div className="rounded-[1.5rem] border border-[#eadacc] bg-[linear-gradient(135deg,#213343,#3f5a68)] p-6 text-white shadow-[0_18px_36px_rgba(15,23,42,0.16)]">
