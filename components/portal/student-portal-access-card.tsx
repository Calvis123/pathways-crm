...
function PortalHighlight({
  ...
  return (
    <div className="rounded-[1.4rem] border border-[#eadfd4] bg-white/85 p-4 shadow-[0_14px_30px_rgba(33,51,67,0.06)] dark:border-white/10 dark:bg-[linear-gradient(180deg,#17253a_0%,#101b2d_100%)] dark:shadow-[0_22px_44px_rgba(2,6,23,0.24)]">
      <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,#173042,#2d5165)] text-white dark:bg-[linear-gradient(135deg,#ff7a59,#cf6a34)] dark:shadow-[0_16px_28px_rgba(255,122,89,0.18)]">
        {icon}
      </div>
      <p className="mt-4 font-semibold text-[#173042] dark:text-[#f8fafc]">{title}</p>
    ...
    <div className={compact ? "w-full" : "relative mx-auto flex min-h-screen max-w-3xl items-center justify-center px-4 py-10 lg:px-8"}>
      <div className={compact ? "w-full rounded-[2rem] border border-[#e9d8c8] bg-[linear-gradient(180deg,#fffdf9_0%,#fff6ef_100%)] p-5 shadow-[0_30px_80px_rgba(33,51,67,0.14)] backdrop-blur dark:border-[#24344d] dark:bg-[linear-gradient(180deg,#111b2d_0%,#0d1627_100%)] dark:shadow-[0_30px_80px_rgba(2,6,23,0.36)] sm:p-6" : "w-full rounded-[2.25rem] border border-[#e9d8c8] bg-white/92 p-6 shadow-[0_30px_80px_rgba(33,51,67,0.14)] backdrop-blur dark:border-white/10 dark:bg-[#111c30]/92 dark:shadow-[0_30px_80px_rgba(2,6,23,0.32)] sm:p-8"}>
        {compact ? (
          <div className="mb-5 flex items-start justify-between gap-4 border-b border-[#ecddd1] pb-5 dark:border-white/8">
            <div>
              ...
              <h1 className="mt-4 text-2xl font-semibold tracking-tight text-[#173042] dark:text-[#f8fafc]">
                Sign in to continue
              </h1>
            ...
            <ThemeToggle className="border-[#ead5c4] bg-white/90 text-[#173042] shadow-[0_10px_26px_rgba(33,51,67,0.06)] dark:border-[#31415b] dark:bg-[linear-gradient(180deg,#202d43_0%,#182438_100%)] dark:text-white dark:shadow-[0_14px_28px_rgba(2,6,23,0.2)]" />
          </div>
        ) : (
          <>
        ...
        <div className={compact ? "rounded-[1.75rem] border border-[#ecd9cb] bg-white/88 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.75)] dark:border-[#31415b] dark:bg-[linear-gradient(180deg,#18253a_0%,#122033_100%)] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_20px_40px_rgba(2,6,23,0.2)] sm:p-6" : "mt-6 rounded-[1.9rem] border border-[#ecd9cb] bg-[#fffaf6]/92 p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.75)] dark:border-white/10 dark:bg-[#162338]/92 sm:p-8"}>
          ...
          <h2 className={compact ? "mt-5 text-2xl font-semibold text-[#173042] dark:text-[#f8fafc]" : "mt-6 text-3xl font-semibold text-[#173042] dark:text-white"}>Sign in to your portal</h2>
          ...
          <form ref={formRef} className={compact ? "mt-5 space-y-3.5" : "mt-6 space-y-4"} onSubmit={handleLogin}>
            <label className="block text-sm text-[#5b6f86] dark:text-[#c9d5e3]">
              <span className="mb-2 block font-medium text-[#173042] dark:text-[#f8fafc]">Email Address</span>
              <input
                type="email"
                className="w-full rounded-2xl border border-[#e4d3c4] bg-[#fffaf6] px-4 py-3 text-[#173042] outline-none ring-[#ff7a59]/25 transition focus:border-[#ffb089] focus:bg-white focus:ring-2 dark:border-white/10 dark:bg-[#162236] dark:text-white dark:focus:bg-[#1a2740]"
            ...
            <label className="block text-sm text-[#5b6f86] dark:text-[#c9d5e3]">
              <span className="mb-2 block font-medium text-[#173042] dark:text-[#f8fafc]">Phone Number</span>
              <input
                type="tel"
                className="w-full rounded-2xl border border-[#e4d3c4] bg-[#fffaf6] px-4 py-3 text-[#173042] outline-none ring-[#ff7a59]/25 transition focus:border-[#ffb089] focus:bg-white focus:ring-2 dark:border-white/10 dark:bg-[#162236] dark:text-white dark:focus:bg-[#1a2740]"
            ...
            <p className="text-sm font-semibold text-[#173042] dark:text-[#f8fafc]">Need access or support?</p>
            <p className="mt-2 text-sm leading-6 text-[#5b6f86] dark:text-[#c9d5e3]">
