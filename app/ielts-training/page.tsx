  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[linear-gradient(135deg,#f7efe7_0%,#fff6ef_48%,#f4efe8_100%)] px-4 py-8 dark:bg-[linear-gradient(135deg,#0f172a_0%,#1e293b_50%,#0f172a_100%)]">
      ...
      <div className="relative w-full max-w-[560px] overflow-hidden rounded-[2rem] border border-gold/25 bg-white/95 shadow-[0_25px_80px_rgba(0,0,0,0.15)] backdrop-blur dark:border-white/10 dark:bg-[linear-gradient(180deg,#111c30_0%,#0d1627_100%)] dark:shadow-[0_25px_80px_rgba(0,0,0,0.35)]">
        ...
        <section className="relative overflow-hidden bg-ink px-8 py-10 text-center text-white dark:bg-[linear-gradient(180deg,#18263d_0%,#132034_100%)]">
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(175,146,51,0.12),transparent_45%)] dark:bg-[radial-gradient(circle_at_30%_50%,rgba(255,122,89,0.12),transparent_45%)]" />
        ...
        <section className="px-8 py-8 dark:text-slate-200">
          {status === "success" && links ? (
            <div className="py-4 text-center">
              ...
              <h2 className="mt-6 font-serif text-3xl text-ink dark:text-white">Registration Complete</h2>
              <p className="mt-3 text-slate-500 dark:text-slate-300">We have received your application for training.</p>

              <div className="mt-6 rounded-2xl border border-emerald-200 bg-emerald-50 p-5 text-left dark:border-emerald-500/30 dark:bg-emerald-500/10">
                <div className="mb-3 text-sm text-ink dark:text-emerald-100">Our team will contact you on WhatsApp within 24 hours</div>
                <div className="mb-3 text-sm text-ink dark:text-emerald-100">You will receive your assessment details via email</div>
                <div className="text-sm text-ink dark:text-emerald-100">Prepare for your first training session</div>
              </div>
              ...
              <div className="mt-6 grid gap-3">
                ...
                <a
                  ...
                  className="text-sm font-semibold text-gold transition hover:underline dark:text-[#ffd6c4]"
                >
            ...
            <>
              {error ? (
                <div className="mb-6 rounded-2xl border-l-4 border-rose-600 bg-rose-50 px-4 py-4 text-sm font-semibold text-rose-700 dark:bg-rose-500/10 dark:text-rose-200">
                  {error}
                </div>
              ) : null}
              ...
              <form action={handleSubmit} className="grid gap-5">
                ...
                <div className="grid gap-2">
                  <label className="text-xs font-bold uppercase tracking-[0.08em] text-ink dark:text-white">Full Name</label>
                  <input
                    name="full_name"
                    required
                ...
                <div className="grid gap-2">
                  <label className="text-xs font-bold uppercase tracking-[0.08em] text-ink dark:text-white">Email Address</label>
                  <input
                    name="email"
                    type="email"
                    required
                ...
                <div className="grid gap-2">
                  <label className="text-xs font-bold uppercase tracking-[0.08em] text-ink dark:text-white">WhatsApp Number</label>
                  <input
                    name="phone"
                    required
                    placeholder="07..."
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="grid gap-2">
                    <label className="text-xs font-bold uppercase tracking-[0.08em] text-ink dark:text-white">Current Location</label>
                    <input
                      name="location"
                      placeholder="City"
                      className="rounded-xl border-2 border-slate-200 bg-slate-50 px-4 py-3 text-sm text-ink outline-none transition focus:border-gold focus:bg-white focus:ring-4 focus:ring-gold/10 dark:border-white/10 dark:bg-white/[0.05] dark:text-white dark:placeholder:text-slate-400 dark:focus:bg-white/[0.08]"
                  ...
                  <div className="grid gap-2">
                    <label className="text-xs font-bold uppercase tracking-[0.08em] text-ink dark:text-white">Target Score</label>
                    <select
                      name="target_score"
                      defaultValue="6.5"
                ...
                <div className="grid gap-2">
                  <label className="text-xs font-bold uppercase tracking-[0.08em] text-ink dark:text-white">Study Destination</label>
                  <select
                    name="destination"
                    defaultValue="UK"
                    className="rounded-xl border-2 border-slate-200 bg-slate-50 px-4 py-3 text-sm text-ink outline-none transition focus:border-gold focus:bg-white focus:ring-4 focus:ring-gold/10 dark:border-white/10 dark:bg-white/[0.05] dark:text-white dark:focus:bg-white/[0.08]"
